...
class Datahandler_COCO():
    ...
    def make_batches(self,batchsize=4,inputshape=(320,320),augmentation=None,Train=True):
        batch_images = []
        batch_masks = []
        list = self.image_ids
        #print(self.image_ids)
...
class Default_Generator():
    def __init__(self, image_dir, annotation_dir):
        ...
        for name in msk_dir:
            ...
            self.img_list.append(cv2.imread(os.path.join(image_dir, name)))
    ...
    def make_batches(self, batchsize=4, inputshape=(320, 320), augmentation=None, Train=True):
        ...
        while True:
            for i in  range (len(self.mask_list)):
                ...
                img = cv2.resize(self.img_list[i], inputshape)
                mask = cv2.resize(self.mask_list[i], inputshape)
                ...
                if len(batch_images) == batchsize:
                    ...
                    batch_images = []
                    batch_masks = []
#d=Datahandler("/Users/nomanshafqat/Desktop/screenshots", "/Users/nomanshafqat/Desktop/labelled")